...
SOURCE_PROJECT = Variable.get('conciliacion_prod')
SOURCE_BUCKET = 'storageproductioncluster-prod-replica'
TARGET_BUCKET = 'conciliacion-uat-backup'
...
# Instantiate a dataproc workflow template for each type of file to process 
    dataproc_ipm = DataprocInstantiateWorkflowTemplateOperator(
        ...
        parameters={
            ...
            'INPUT':'gs://storageproductioncluster-prod-replica/data/ipm/MCI.AR.T112.M.E0073610.D*',
            'TYPE_FILE':'ipm',
    ...
    dataproc_opd = DataprocInstantiateWorkflowTemplateOperator(
        ...
        parameters={
            ...
            'JOBFILE':'gs://mark-vii-conciliacion/artifacts/dataproc/pyspark_data_process.py',
            'FILES_OPERATORS':'gs://mark-vii-conciliacion/artifacts/dataproc/operators/*',
            'INPUT':'gs://storageproductioncluster-prod-replica/data/opd/PLJ61110.FINT0003*',
            'TYPE_FILE':'opd',
    ...
    dataproc_incident = DataprocInstantiateWorkflowTemplateOperator(
        ...
        parameters={
            ...
            'JOBFILE':'gs://mark-vii-conciliacion/artifacts/dataproc/pyspark_data_process.py',
            'FILES_OPERATORS':'gs://mark-vii-conciliacion/artifacts/dataproc/operators/*',
            'INPUT':'s://storageproductioncluster-prod-replica/data/incident/PLJ62100-CONS-INC-PEND-TENPO*',
            'TYPE_FILE':'incident',
